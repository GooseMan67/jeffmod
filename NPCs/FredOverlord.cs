...
namespace jeffmod.NPCs
{
    [AutoloadBossHead]
    public class FredOverlord : ModNPC
    {
        ...
        {
            DisplayName.SetDefault("Fred The Undying Tyrant");
        ...
        public override void SetDefaults()
        {
            ...
            npc.lifeMax = 1000000; // The Max HP the boss has on Normal
            npc.damage = 200; // The base damage value the boss has on Normal
            npc.defense = 50; // The base defense on Normal
            ...
            music = MusicID.Hell;
            bossBag = mod.ItemType("FredBag"); // Needed for the NPC to drop loot bag.
        }
        ...
        private void Shoot()
        {
            int type = mod.ProjectileType("FireBlast");
        ...
        public override void NPCLoot()
        {
            ...
            else
            {
                ...
                {
                    Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("TyrantEdge"));
                }
                Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("HellstoneBar")); // For Items that you want to always drop
            }
